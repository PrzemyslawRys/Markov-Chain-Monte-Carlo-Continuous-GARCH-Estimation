...
estimatorsRV <- bind_cols(RVH = getStandardEstimators(getRealizedVarianceSeries(SPXMins_withEta40$R, 60, 1 / (252 * 405)),
                                                      SPXMins_withEta40$R,
                                                      1 / (252 * 405)),
                          RVD = getStandardEstimators(getRealizedVarianceSeries(SPXMins_withEta40$R, 405, 1 / (252 * 405)),
                                                  SPXMins_withEta40$R,
                                                  1 / (252 * 405)),
                          RVW = getStandardEstimators(getRealizedVarianceSeries(SPXMins_withEta40$R, 2025, 1 / (252 * 405)),
                                                  SPXMins_withEta40$R,
                                                  1 / (252 * 405)),
                          RvM = getStandardEstimators(getRealizedVarianceSeries(SPXMins_withEta40$R, 8505, 1 / (252 * 405)),
                                                  SPXMins_withEta40$R,
                                                  1 / (252 * 405))) %>%
  as.data.frame()
